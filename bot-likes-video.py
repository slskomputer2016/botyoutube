...
#--------------------------------------------------
def youtubeLikes(driver,url,email):
    time.sleep(5)
    ...
    #wait.until(EC.visibility_of_element_located((By.XPATH, '//*[@id="segmented-like-button"]'))).click()
    # like_button = WebDriverWait(driver, 10).until(
    #     EC.element_to_be_clickable((By.CSS_SELECTOR, "button[aria-label='Like']"))
    #     # Or use By.XPATH, e.g., (By.XPATH, "//div[@aria-label='Like']/div/div")
    # )
    like_button = WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, "//div[@aria-label='Like']/div/div"))
        # Or use By.XPATH, e.g., (By.XPATH, "//div[@aria-label='Like']/div/div")
    )
    like_button.click()
    print('')
...
def main():
    ...
    for email in data_email:
        try:
            ...
            youtubeLikes(driver,link_sub,email)
